...
//        BiomeSettings
    ...
    private static Biome createIrradiatedRiver(HolderGetter<PlacedFeature> placedFeatures,
                                               HolderGetter<ConfiguredWorldCarver<?>> worldCarvers) {
        var mobBuilder = new MobSpawnSettings.Builder();
        ...
        var effects = new BiomeSpecialEffects.Builder()
                .fogColor(0x6A7A6D)      // faintly green, river mist
                .waterColor(0x2F7046)    // irradiated green river water
                .waterFogColor(0x588065) // underwater haze
                .skyColor(0x6F8977)
                .build();
