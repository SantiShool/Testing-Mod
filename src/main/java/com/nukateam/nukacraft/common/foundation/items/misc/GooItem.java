...
public class GooItem<T extends ThrowableGrenadeEntity> extends GrenadeItem {
    ...
    public GooItem(Properties properties, int maxCookTime, GrenadeFactory<T> factory) {
        super(properties, maxCookTime);
        this.grenadeFactory = factory;
    }

    public GooItem(Properties properties, int maxCookTime, GrenadeFactory<T> factory, @Nullable Supplier<SoundEvent> soundEvent) {
