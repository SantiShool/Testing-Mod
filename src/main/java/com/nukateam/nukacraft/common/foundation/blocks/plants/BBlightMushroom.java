...
public class BBlightMushroom extends CocoaBlock {
    ...
    public BBlightMushroom(Properties pProperties) {
        super(pProperties);
    }
    ...
    public InteractionResult use(BlockState state, Level level, BlockPos pos, Player player, InteractionHand hand, BlockHitResult result) {
        ...
        if (!flag && adhesive) {
            ...
            popResource(level, pos, new ItemStack(ModFood.BRIGHT_BLIGHT.get(), j + (flag ? 1 : 0)));
